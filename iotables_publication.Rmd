...
author: "Daniel Antal, Leo Lahti, CFA"
...
The supply and use tables (SUTs) and input-output tables (in short: IOTs) provide a very detailed, and empirically measured or estimated picture of the economy.  Such tables present information on the supply and use of goods and services for industries’ intermediate consumption and categories of final use
